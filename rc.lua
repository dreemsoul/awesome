...
tags = { names = { "I", "II", "III", "IV", "V", "VI", "VII" }, layout = { layouts[11], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[2]  }
}
for s = 1, screen.count() do
...
vicious.register(batwidget, vicious.widgets.bat, " " .. i .. " "
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ modkey, "Control"  }, "j"     , function () awful.util.spawn("nicotine.py"                   ) end),
