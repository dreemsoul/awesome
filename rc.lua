...
-- beautiful.init("~/.config/awesome/blind/arrow/themeSciFiGrad.lua")
...
tags = { names = { "Web  ", "Irc  ", "Mumble   ", "Music  ", "Term  ", "Games  ", "Misc  " }, layout = { layouts[11], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[2]  }
}
for s = 1, screen.count() do
...
mylauncher = awful.widget.launcher({ image = "/home/morningstar/Pictures/Icons/arch.png",
                                     menu = mymainmenu })
...
vicious.register(pacwidget, vicious.widgets.pkg,
                function(widget,args)
                    ...
                    local s = io.popen("pacman -Qub /tmp/checkup-db-morningstar")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control"  }, "g"     , function () awful.util.spawn("tor-browser-en"                ) end),
    awful.key({ modkey, "Control"  }, "z"     , function () awful.util.spawn("urxvt -e ranger"               ) end),   
    awful.key({ modkey, "Control"  }, "m"     , function () awful.util.spawn("urxvt -name moc -title moc -e tmux new mocp"        ) end),
    awful.key({ modkey, "Control"  }, "b"     , function () awful.util.spawn("urxvt -name weechat -title weechat -e weechat"              ) end),
    awful.key({ modkey, "Control"  }, "w"     , function () awful.util.spawn("urxvt -e tmux new wicd-curses" ) end),
    awful.key({ modkey, "Control"  }, "l"     , function () awful.util.spawn("libreoffice"                   ) end),
    awful.key({ modkey, "Control"  }, "e"     , function () awful.util.spawn("urxvt -name mutt -title mutt -e tmux new mutt"        ) end),
    awful.key({ modkey, "Control"  }, "h"     , function () awful.util.spawn("urxvt -e tmux new htop"        ) end),
